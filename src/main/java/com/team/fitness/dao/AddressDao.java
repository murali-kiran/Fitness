...
import com.team.fitness.dto.Address;
...
public class AddressDao {
    ...
    logger.info("finding Address instance with property: "+ propertyName + ", value: " + value);
		try {
			String queryString;
			queryString = "select model from Address model where model."
