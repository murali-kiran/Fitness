...
import com.team.fitness.dto.Employee;
...
public class EmployeeDao {
	...
	public void delete(Employee entity) {
		...
		try {
			entity = entityManager.getReference(Employee.class,
	...
	public Employee update(Employee entity) {
		...
		try {
			Employee result = entityManager.merge(entity);
    ...
    logger.info("finding Employee instance with property: "+ propertyName + ", value: " + value);
		try {
			String queryString;
			queryString = "select model from Employee model where model."
